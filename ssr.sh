...
libsodium_url="https://download.libsodium.org/libsodium/releases/old/unsupported/libsodium-1.0.17.tar.gz"
...
pre_install(){
    ...
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="13579"
    echo
    echo "---------------------------"
    ...
    [ -z "${shadowsocksport}" ] && shadowsocksport=19200
